...
job::job({
  ...
  tar_script({
    ...
    list(
      ...
      tar_target(
        cellchat_file,
        "cellNexus_lr_signaling_pathway_strength.duckdb",
        format = "file"
      ),
      tar_target(
        ethnicity_imputed,
        {
          read_csv("All_pseudobulk_1_0_6_ethnicity_imputed_colData.csv") |> 
  ...
  ask = FALSE, 
  script = "cellchat_brms_1_6_12_d/_targets.R"
  )
  
  tar_make(
    # callr_function = NULL,
    script = "cellchat_brms_1_6_12_d/_targets.R", 
    store ="cellchat_brms_1_6_12_d/_targets", 
...
tar_poll(store ="cellchat_brms_1_6_12_d/_targets")
    ...
    left_join(
      duckdb::duckdb() |>
        dbConnect(dbdir =
                    tar_read(
                      cellchat_file,
                      store ="cellchat_brms_1_6_12_c/_targets"
                    ),
                  read_only = TRUE
        )    |>
        tbl("lr_pathway_table") |> 
...
set.seed(42)
store_path <- "cellchat_brms_1_6_12_d/_targets"
