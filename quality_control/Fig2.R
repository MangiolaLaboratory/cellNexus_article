...
alluvial = (tissue_assay_alluvial + tissue_disease_alluvial) + plot_layout(widths = c(1,1))&theme(legend.position = "none")
left_bottom = (alive_per_donor_scatter + p_library_size) + plot_layout(guides = "collect",
                                                                        widths = c(2,2))
