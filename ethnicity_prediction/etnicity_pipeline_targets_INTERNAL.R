...
pseudobulk_sample = 
 ...
 rd = rowData(pseudobulk_sample) |> as_tibble(rownames = ".feature") |> left_join(summaries) |> as("DFrame")
  rownames(rd) = rd$.feature
  rd = rd[,-1]
 rowData(pseudobulk_sample) = rd
...
pseudobulk_sample |> HDF5Array::saveHDF5SummarizedExperiment("pseudobulk_sample")
