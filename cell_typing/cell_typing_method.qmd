...
```{r}
# Download from Zenodo (https://zenodo.org/records/19909778)
output_parquet = "data_driven_consensus.parquet"
...
graph_from_data_frame(
  rbind(tbl_immune, edgedf|>select(from,to,Approach)),
  vertices = nodedf, directed = TRUE) |> 
  as_tbl_graph() |> 
  activate(nodes) |> 
  mutate(
