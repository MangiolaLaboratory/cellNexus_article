# This script aggregates the QC-processed single-cell data from step 6 into
# pseudobulk SummarizedExperiment objects, stratified by dataset, sample, and
# consensus cell type, and writes them to the cellNexus local pseudobulk cache
# in chunked h5ad files. The pipeline is orchestrated with {targets} and
# dispatched across a tiered hierarchy of SLURM workers.
