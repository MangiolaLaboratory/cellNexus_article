# This supplementary script builds a mapping between cell IDs and their
# corresponding cellNexus single-cell file IDs, reading from the consensus
# cell-type metadata parquet produced in step 7. For each file, it assigns a
# stable integer cell index ordered by cell ID and writes the resulting
# dictionary to a compressed parquet for use in downstream cache preparation.
# The pipeline is orchestrated with {targets} and dispatched across SLURM
